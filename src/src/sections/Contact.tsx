...
const MailIcon = ({ className = 'text-amber-400 mb-2' }: { className?: string }) => (
...
const PhoneIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-amber-400 mb-2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
);
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col items-center gap-10">
                    <Reveal delay={200} width="100%">
                        <div className="flex flex-col items-center gap-4 p-8 bg-surface rounded-3xl border border-white/[0.06] w-full hover:border-amber-500/20 transition-all duration-300 shadow-2xl">
                            <div className="flex flex-col md:flex-row gap-12 items-center justify-center w-full">
                                <div className="flex flex-col items-center group cursor-pointer">
                                    <div className="p-3.5 bg-amber-500/10 border border-amber-500/20 rounded-full mb-3 group-hover:scale-110 transition-transform">
                                        <MailIcon />
                                    </div>
