...
export const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles = "inline-flex items-center justify-center rounded-lg font-bold transition-all focus:outline-none focus:ring-2 focus:ring-accent/50 focus:ring-offset-2 focus:ring-offset-carbon disabled:opacity-50 disabled:pointer-events-none select-none";

    const variants = {
        primary: "bg-accent text-slate-950 hover:bg-amber-400 hover:scale-[1.02] shadow-lg shadow-amber-950/20 active:scale-[0.98]",
